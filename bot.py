...
bot.login(username="sensexbets",password="SIDqwer123@")

post_ids=[]

reddit = praw.Reddit(client_id='TI2IJhCvheU7y3CpAIrOyw',
        client_secret='XQAvczZdUNmJmWaP4RkGUmakbUiIvg',
        username='st1275857',
        password='ffxtffE;3/3.Sdx',
        user_agent='st1275857')
...
captionTags = "#meme #memebot #dankmemes"
